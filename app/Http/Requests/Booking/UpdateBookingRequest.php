...
class UpdateBookingRequest extends FormRequest
{
    ...
    {
        return [
            // SEC-07: only allow content/schedule fields — status, approver_id,
            // booking_number, created_by are intentionally excluded to prevent
            // clients from escalating or manipulating booking state directly.
