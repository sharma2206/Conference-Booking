    ...
    <div className="p-4 sm:p-6 space-y-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900 dark:text-white">{hall.name}</h1>
            <p className="text-sm text-gray-500 dark:text-slate-400 mt-0.5 font-mono">{hall.code}</p>
          </div>
        </div>
        ...
        <div className="xl:col-span-2 space-y-5">
          ...
          {hall.description && (
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-gray-700 dark:text-slate-300 leading-relaxed">{hall.description}</p>
              </CardContent>
            </Card>
          )}
              ...
              <CardContent>
                <div className="flex flex-wrap gap-2">
                  {hall.amenities.map(a => (
                    <span key={a} className="px-3 py-1 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 rounded-full text-xs font-medium">{a}</span>
                  ))}
                </div>
              </CardContent>
            </Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900 dark:text-white">{hall.capacity} persons</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900 dark:text-white">{hall.location}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900 dark:text-white">{hall.building || '—'}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="h-9 w-9 rounded-lg bg-yellow-50 dark:bg-yellow-900/20 flex items-center justify-center">
                  <Clock className="h-4 w-4 text-yellow-600 dark:text-yellow-400" />
                </div>
                <div>
                  <p className="text-xs text-gray-500 dark:text-slate-400">Rate</p>
                  <p className="text-sm font-semibold text-gray-900 dark:text-white">{hall.hourly_rate ? `₹${hall.hourly_rate}/hr` : 'Free'}</p>
                </div>
              </div>
            </CardContent>
          </Card>
